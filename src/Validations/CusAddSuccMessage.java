 ...
 * @author ASUS
 */
public class CusAddSuccMessage extends javax.swing.JFrame {

    /**
     * Creates new form cusaddsuccMessage
     */
    public CusAddSuccMessage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Customer Added Successfully");
        ...
        jPanel3.add(jbNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 69, 20));
        ...
        jPanel3.add(menu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, -30, 440, 250));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusAddSuccMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusAddSuccMessage().setVisible(true);
            }
        });
    }
